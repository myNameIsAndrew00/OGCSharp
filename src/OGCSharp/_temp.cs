...
namespace SharpMap.Web.Wms
{
    ...
    public class Client : IClient
    {
        ...
        private void ParseServiceDescription(XmlNode xnlServiceDescription)
        {
            ...
            node = xnlServiceDescription.SelectSingleNode(
        ...
        private WmsServerLayer ParseLayer(XmlNode xmlLayer)
        {
            ...
            layer.SRIDBoundingBoxes = new List<WmsSpatialReferencedBoundingBox>();
            ...
            foreach (XmlNode bbox in bboxes)
            {
                ...
                layer.SRIDBoundingBoxes.Add(new WmsSpatialReferencedBoundingBox(minx, miny, maxx, maxy, epsg));
            }
            return layer;
        }
